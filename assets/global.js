...
class MenuDrawer extends HTMLElement {
  ...
  closeMenuDrawer(event, elementToFocus = false) {
    ...
    this.mainDetailsToggle.closest('.header').classList.remove('menu-drawer-open');
...
class HeaderDrawer extends MenuDrawer {
  ...
  openMenuDrawer(summaryElement) {
    ...
    document.querySelector('.announcement-bar-section').classList.add('menu-open');
    
    setTimeout(() => {
      this.mainDetailsToggle.classList.add('menu-opening');
      this.mainDetailsToggle.closest('.header').classList.add('menu-drawer-open');
    });
  ...
  closeMenuDrawer(event, elementToFocus) {
    ...
    document.querySelector('.announcement-bar-section').classList.remove('menu-open');
...
function updateAnnouncementHeight() {
  const utilityBarSection = document.querySelector('.announcement-bar-section .utility-bar');
...
function updateSearchBarHeight() {
  const utilityBarSection = document.querySelector('.search-modal .search-modal__content');
  if (!utilityBarSection) return;
  ...
  document.documentElement.style.setProperty('--search-bar-height', `${visibleHeight}px`);
}
window.addEventListener('load', updateSearchBarHeight);
window.addEventListener('resize', updateSearchBarHeight);
window.addEventListener('scroll', updateSearchBarHeight);
function updateHeaderHeight() {
  const utilityBarSection = document.querySelector('.section-header');
  if (!utilityBarSection) return;
  ...
  document.documentElement.style.setProperty('--custom-header-height', `${visibleHeight}px`);
}
window.addEventListener('load', updateHeaderHeight);
window.addEventListener('resize', updateHeaderHeight);
window.addEventListener('scroll', updateHeaderHeight);

const customGridSorting = document.querySelector('.custom-grid-sorting');
if (customGridSorting) {
  document.querySelectorAll('.custom-grid-sorting li').forEach(li => {
    li.addEventListener('click', async function() {
      const liValue = this.getAttribute('value');
      
      if (liValue) {
        document.querySelectorAll('.custom-grid-sorting li').forEach(item => {
        ...
        try {
          ...
          currentUrl.searchParams.set('sort_by', liValue);
          ...
          const newProductCount = doc.querySelector('#ProductCountDesktop');
          const currentProductCount = document.querySelector('#ProductCountDesktop');
          if (newProductCount && currentProductCount) {
            currentProductCount.innerHTML = newProductCount.innerHTML;
          }
          
          const newMobileProductCount = doc.querySelector('#ProductCount');
          const currentMobileProductCount = document.querySelector('#ProductCount');
          if (newMobileProductCount && currentMobileProductCount) {
            currentMobileProductCount.innerHTML = newMobileProductCount.innerHTML;
          }
